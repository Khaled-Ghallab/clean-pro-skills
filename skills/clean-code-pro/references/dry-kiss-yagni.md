...
- **Function length:** target ≤20 lines (Clean Code), ~50 as a hard cap; common static-analysis defaults (SonarQube, PMD) flag >50–60 lines. Pair with the complexity ceiling rather than relying on LOC alone.

...
**Rule.** A function does one thing. If the prompt asks for N things, produce N functions and a small composer. Target ≤20 lines; hard caps: ~50 lines, ≤4 parameters, cyclomatic complexity ≤10 — refactor before exceeding.
